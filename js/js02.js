...
// 1. mapDiv
//=============================================================================
const map = new kakao.maps.Map( initOption.container, initOption.mapOption);
{
...
let toggleOverlayMapTypeId = (function(){
	const overlays = {
		terrain : {on:false, type:kakao.maps.MapTypeId.TERRAIN}, 
		use_district  : {on:false, type:kakao.maps.MapTypeId.USE_DISTRICT} 
	};
